	...
	return (
		<div>
			...
			<div className="container text-center">
				...
				></div>
				<div className="p-3">
					Go to the <Link href="/repair-service">price list</Link> and use your
				...
				<div className="p-3">
					...
					<Link href="/order-online">create a ticket</Link> for your customer,
				...
				<div className="text-center m-5">
					...
					<Link href="/contact-us">
						<a className="button button-primary px-3 py-1 h5">Contact us</a>
					</Link>
				</div>
			</div>
		</div>
