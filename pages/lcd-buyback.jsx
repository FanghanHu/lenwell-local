			...
			<div className="container">
				<div className="row">
					<div className="col-12 col-md-6 p-3">
						<img className="rounded w-100" src="/bg-home6.jpg" alt="lcd buyback" />
					</div>
				...
				<div className="m-5 text-center">
					<Link href="/contact-us"><a className="btn btn-outline-dark rounded-pill px-4 py-1" >Contact us</a></Link>
				</div>
			</div>
		</div>
	);
