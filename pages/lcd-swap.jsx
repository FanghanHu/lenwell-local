...
export default function LcdSwap() {
    return (
        <div>
            ...
            <div className="background" style={{backgroundImage: `url(/phone-repiar.jpg)`, width:"100%", height:"350px"}}></div>
            <div className="text-center">
                ...
                <img className="m-4" src="/mobile-repair-logo.svg" alt="lcd swap" width="300px" />
