			...
			<div className="container" style={{ marginBottom: "-10px", zIndex: -1}}>
				<div className="row justify-content-between align-items-end">
					<div className="col-7 col-lg-6">
						<img src="/iPads.jpg" style={{mixBlendMode: "multiply"}} alt="ipads" width="100%" />
					</div>
					<div className="col-4 col-lg-3">
						<img src="/samsung.jpg" style={{mixBlendMode: "multiply"}} alt="samsung" width="100%" />
					</div>
				</div>
			</div>
			...
			<div className="d-flex justify-content-center align-items-center m-5">
				...
				<div>
					<a href="https://www.ebay.com/str/lenwellscreenfactory">
						<img className={style["ecommerce-icon"]} src="/ebay.png" alt="eBay" />
					</a>
					<hr/>
					<a href="https://www.amazon.com/s?me=A102LBUVI7JL8T&marketplaceID=ATVPDKIKX0DER">
						<img className={style["ecommerce-icon"]} src="/amazon.png" alt="amazon" />
					</a>
				</div>
			</div>
		</div>
